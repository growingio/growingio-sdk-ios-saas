...
@interface FMG3DatabasePool()

- (void)pushDatabaseBackInPool:(FMG3Database*)db;
- (FMG3Database*)db;

@end


@implementation FMG3DatabasePool
...
- (FMG3Database*)db {
    ...
    [self executeLocked:^() {
        ...
        if (db) {
            ...
            db = [FMG3Database databaseWithPath:self->_path];
