...
NSString *const GrowingGCDAsyncSocketException = @"GrowingGCDAsyncSocketException";
NSString *const GrowingGCDAsyncSocketErrorDomain = @"GrowingGCDAsyncSocketErrorDomain";

NSString *const GrowingGCDAsyncSocketQueueName = @"GrowingGCDAsyncSocket";
NSString *const GrowingGCDAsyncSocketThreadName = @"GrowingGCDAsyncSocket-CFStream";

#if SECURE_TRANSPORT_MAYBE_AVAILABLE
NSString *const GrowingGCDAsyncSocketSSLCipherSuites = @"GrowingGCDAsyncSocketSSLCipherSuites";
#if TARGET_OS_IPHONE
NSString *const GrowingGCDAsyncSocketSSLProtocolVersionMin = @"GrowingGCDAsyncSocketSSLProtocolVersionMin";
NSString *const GrowingGCDAsyncSocketSSLProtocolVersionMax = @"GrowingGCDAsyncSocketSSLProtocolVersionMax";
#else
NSString *const GrowingGCDAsyncSocketSSLDiffieHellmanParameters = @"GrowingGCDAsyncSocketSSLDiffieHellmanParameters";
#endif
#endif

enum GrowingGCDAsyncSocketFlags
{
	kSocketStarted                 = 1 <<  0,  
	kConnected                     = 1 <<  1,  
...
enum GrowingGCDAsyncSocketConfig
{
	kIPv4Disabled              = 1 << 0,  
	kIPv6Disabled              = 1 << 1,  
	kPreferIPv6                = 1 << 2,  
...
@interface GrowingGCDAsyncSocket ()
{
	uint32_t flags;
	uint16_t config;
	...
	GrowingGCDAsyncReadPacket *currentRead;
	GrowingGCDAsyncWritePacket *currentWrite;
	
	unsigned long socketFDBytesAvailable;
	
	GrowingGCDAsyncSocketPreBuffer *preBuffer;
	...
	GrowingGCDAsyncSocketPreBuffer *sslPreBuffer;
...
@interface GrowingGCDAsyncSocketPreBuffer : NSObject
{
	uint8_t *preBuffer;
...
@implementation GrowingGCDAsyncSocketPreBuffer
...
@interface GrowingGCDAsyncReadPacket : NSObject
{
  @public
...
- (NSUInteger)readLengthForTermWithPreBuffer:(GrowingGCDAsyncSocketPreBuffer *)preBuffer found:(BOOL *)foundPtr;

- (NSInteger)searchForTermAfterPreBuffering:(ssize_t)numBytes;

@end

@implementation GrowingGCDAsyncReadPacket
...
@interface GrowingGCDAsyncWritePacket : NSObject
{
  @public
	NSData *buffer;
	NSUInteger bytesDone;
...
@implementation GrowingGCDAsyncWritePacket
...
@interface GrowingGCDAsyncSpecialPacket : NSObject
{
  @public
...
@implementation GrowingGCDAsyncSpecialPacket
...
@implementation GrowingGCDAsyncSocket
...
- (id)initWithDelegate:(id)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	if((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([GrowingGCDAsyncSocketQueueName UTF8String], NULL);
		}
		...
		preBuffer = [[GrowingGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
	}
	return self;
}
...
- (BOOL)doAccept:(int)parentSocketFD
{
	...
	if (delegateQueue)
	{
		...
		dispatch_async(delegateQueue, ^{ @autoreleasepool {
			...
			GrowingGCDAsyncSocket *acceptedSocket = [[GrowingGCDAsyncSocket alloc] initWithDelegate:theDelegate
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:GrowingGCDAsyncSocketErrorDomain code:GrowingGCDAsyncSocketBadConfigError userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:GrowingGCDAsyncSocketErrorDomain code:GrowingGCDAsyncSocketBadParamError userInfo:userInfo];
}
...
- (NSError *)connectTimeoutError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GrowingGCDAsyncSocketConnectTimeoutError",
	                                                     @"GrowingGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Attempt to connect to host timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:GrowingGCDAsyncSocketErrorDomain code:GrowingGCDAsyncSocketConnectTimeoutError userInfo:userInfo];
}


- (NSError *)readMaxedOutError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GrowingGCDAsyncSocketReadMaxedOutError",
														 @"GrowingGCDAsyncSocket", [NSBundle mainBundle],
														 @"Read operation reached set maximum length", nil);
	
	NSDictionary *info = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:GrowingGCDAsyncSocketErrorDomain code:GrowingGCDAsyncSocketReadMaxedOutError userInfo:info];
}


- (NSError *)readTimeoutError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GrowingGCDAsyncSocketReadTimeoutError",
	                                                     @"GrowingGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Read operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:GrowingGCDAsyncSocketErrorDomain code:GrowingGCDAsyncSocketReadTimeoutError userInfo:userInfo];
}


- (NSError *)writeTimeoutError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GrowingGCDAsyncSocketWriteTimeoutError",
	                                                     @"GrowingGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Write operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:GrowingGCDAsyncSocketErrorDomain code:GrowingGCDAsyncSocketWriteTimeoutError userInfo:userInfo];
}

- (NSError *)connectionClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GrowingGCDAsyncSocketClosedError",
	                                                     @"GrowingGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Socket closed by remote peer", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:GrowingGCDAsyncSocketErrorDomain code:GrowingGCDAsyncSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:GrowingGCDAsyncSocketErrorDomain code:GrowingGCDAsyncSocketOtherError userInfo:userInfo];
}
                        ...
                        tag:(long)tag
{
	...
	GrowingGCDAsyncReadPacket *packet = [[GrowingGCDAsyncReadPacket alloc] initWithData:buffer
	                                                          startOffset:offset
	                                                            maxLength:length
	                                                              timeout:timeout
	                                                           readLength:0
...
- (float)progressOfReadReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentRead || ![currentRead isKindOfClass:[GrowingGCDAsyncReadPacket class]])
		{
...
- (void)maybeDequeueRead
{
	...
	if ((currentRead == nil) && (flags & kConnected))
	{
		if ([readQueue count] > 0)
		{
			...
			if ([currentRead isKindOfClass:[GrowingGCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued GrowingGCDAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued GrowingGCDAsyncReadPacket");
...
- (void)completeCurrentRead
{
	...
	{
		__strong id theDelegate = delegate;
		GrowingGCDAsyncReadPacket *theRead = currentRead; 
...
- (void)writeData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	GrowingGCDAsyncWritePacket *packet = [[GrowingGCDAsyncWritePacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (float)progressOfWriteReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentWrite || ![currentWrite isKindOfClass:[GrowingGCDAsyncWritePacket class]])
		{
...
- (void)maybeDequeueWrite
{
	...
	if ((currentWrite == nil) && (flags & kConnected))
	{
		if ([writeQueue count] > 0)
		{
			...
			if ([currentWrite isKindOfClass:[GrowingGCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued GrowingGCDAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued GrowingGCDAsyncWritePacket");
...
- (void)doWriteTimeout
{
	...
	{
		__strong id theDelegate = delegate;
		GrowingGCDAsyncWritePacket *theWrite = currentWrite;
...
- (void)startTLS:(NSDictionary *)tlsSettings
{
	...
	GrowingGCDAsyncSpecialPacket *packet = [[GrowingGCDAsyncSpecialPacket alloc] initWithTLSSettings:tlsSettings];
...
- (void)maybeStartTLS
{
	...
	if ((flags & kStartingReadTLS) && (flags & kStartingWriteTLS))
	{
		...
		#if TARGET_OS_IPHONE
		{
			GrowingGCDAsyncSpecialPacket *tlsPacket = (GrowingGCDAsyncSpecialPacket *)currentRead;
...
{
	GrowingGCDAsyncSocket *asyncSocket = (__bridge GrowingGCDAsyncSocket *)connection;
...
- (void)ssl_startTLS
{
	...
	#if TARGET_OS_IPHONE
	{
		...
		NSString *sslMinLevel = [tlsSettings objectForKey:GrowingGCDAsyncSocketSSLProtocolVersionMin];
		NSString *sslMaxLevel = [tlsSettings objectForKey:GrowingGCDAsyncSocketSSLProtocolVersionMax];
		...
		if (sslLevel)
		{
			if (sslMinLevel || sslMaxLevel)
			{
				LogWarn(@"kCFStreamSSLLevel security option ignored. Overriden by "
						@"GrowingGCDAsyncSocketSSLProtocolVersionMin and/or GrowingGCDAsyncSocketSSLProtocolVersionMax");
			}
			else
			{
	...
	value = [tlsSettings objectForKey:GrowingGCDAsyncSocketSSLCipherSuites];
	if (value)
	{
	...
	#if !TARGET_OS_IPHONE
	value = [tlsSettings objectForKey:GrowingGCDAsyncSocketSSLDiffieHellmanParameters];
	if (value)
	{
	...
	sslPreBuffer = [[GrowingGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)cf_startTLS
{
	...
	NSAssert([currentRead isKindOfClass:[GrowingGCDAsyncSpecialPacket class]], @"Invalid read packet for startTLS");
	NSAssert([currentWrite isKindOfClass:[GrowingGCDAsyncSpecialPacket class]], @"Invalid write packet for startTLS");
...
{
	[[NSThread currentThread] setName:GrowingGCDAsyncSocketThreadName];
...
+ (void)scheduleCFStreams:(GrowingGCDAsyncSocket *)asyncSocket
{
	LogTrace();
...
+ (void)unscheduleCFStreams:(GrowingGCDAsyncSocket *)asyncSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == cfstreamThread, @"Invoked on wrong thread");
...
{
	GrowingGCDAsyncSocket *asyncSocket = (__bridge GrowingGCDAsyncSocket *)pInfo;
