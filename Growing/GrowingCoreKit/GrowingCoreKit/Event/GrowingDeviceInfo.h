...
@property (nonatomic, copy)     NSString*(^customDeviceIDBlock)(void);
...
@property (nonatomic, readonly) NSNumber *userInstallTime;

@property (nonatomic, readonly) NSString *sessionID;

@property (nonatomic, readonly) NSString *storePath;

@property (nonatomic, readonly) NSString *configAccountID;



@property (nonatomic, assign)   BOOL isResetSIDByWillEnterForeground;
@property (nonatomic, assign)   BOOL isApplicationInWillEnterForeground;
