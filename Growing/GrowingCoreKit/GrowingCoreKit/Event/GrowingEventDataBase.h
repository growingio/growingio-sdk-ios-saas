...
- (NSError*)enumerateKeysAndValuesUsingBlock:(void(^)(NSString* key,NSString *value,BOOL *stop))block;
- (NSUInteger)countOfEvents;

- (void)setValue:(NSString*)value forKey:(NSString *)key;
- (void)setValue:(NSString*)value forKey:(NSString *)key error:(NSError**)error;
