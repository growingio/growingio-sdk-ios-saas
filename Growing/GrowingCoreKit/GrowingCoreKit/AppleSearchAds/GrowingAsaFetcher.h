...
typedef NS_ENUM(NSUInteger, GrowingAsaFetcherStatus) {
    GrowingAsaFetcherStatusDenied = 1,   
    GrowingAsaFetcherStatusFailure,      
    GrowingAsaFetcherStatusFetching,     
    GrowingAsaFetcherStatusSuccess,      
    GrowingAsaFetcherStatusCompleted     
};
